...
const TratamientoIndividual = lazy(
    () => import('@/views/historia/mod/tratamientos/TratamientoiInd'),
)
const ManejoDolor = lazy(
    () => import('@/views/historia/mod/tratamientos/ManejoDolor'),
)
                    ...
                    {navigation.map((nav) => (
                        <button
                            ...
                            className={classNames(
                                'flex items-center gap-2 px-3.5 py-2.5 rounded-full border-2 border-transparent font-semibold transition-colors dark:hover:text-gray-100 text-gray-900 dark:text-white',

...
function InfoAntecedentes() {
  ...
  const antecedentesFamiliares = [
    { parentesco: 'Abuelo', linea: 'Paterno', estado: 'Positivo', estadoColor: 'red' },
    { parentesco: 'Abuela', linea: 'Materna', estado: 'Negativo', estadoColor: 'emerald' },
    { parentesco: 'Padre', linea: 'Paterno', estado: 'Desconocido', estadoColor: 'indigo' },
  ];

...
const FormAntFamiliares = () => {
    ...
    const [mensaje, setMensaje] = useState<{ status: string; message: string } | null>(null);
        ...
        {mensaje && (
            ...
            <div className="flex">
                ...
                <div className="w-full">
                    ...
                    >
                        {selectedNav === 'estadoHBS' && <EstadoHBS setMensaje={setMensaje} />}
                        {selectedNav === 'e_cronicas' && <EnfermedadesCronicas setMensaje={setMensaje}/>}
                    </Suspense>
                </div>
            </div>
        </div>

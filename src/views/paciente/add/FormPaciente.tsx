...
import { postPaciente } from '@/customService/services/pacienteService'
...
function PatientForm() {
    ...
    const onSubmit = async  (data) => {
        try {
            setLoading(true)
            setMensaje('')
            const response = await postPaciente(token, data)
            ...
            setMensaje('Error al guardar el paciente. Inténtalo de nuevo.')
        } finally {
            setLoading(false)
        }
    }
